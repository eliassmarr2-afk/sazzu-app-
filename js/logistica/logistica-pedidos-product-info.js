...
(function () {
  ...
  function bind() {
    ...
    document.addEventListener('click', function (event) {
      ...
      setTimeout(function () { injectForTracking(tracking); decorateTable(); }, 280);
      setTimeout(function () { injectForTracking(tracking); decorateTable(); }, 760);
    }, true);
    const tbody = root().querySelector('#logPedidosTbody');
  ...
  function init() {
    ...
    injectCss();
    bind();
    [700, 1500, 3200, 5200].forEach(t => setTimeout(decorateTable, t));
    window.ProtocolLogisticaPedidosProductInfo = { build: BUILD, decorateTable, injectForTracking };
  }
