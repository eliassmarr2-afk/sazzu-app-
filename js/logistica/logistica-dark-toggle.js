...
(function () {
  ...
  const CONVERSATION_SLIDE_SCRIPT_ID = 'logisticaDarkConversationSlideReferenceScript';
  const CONVERSATION_SLIDE_SCRIPT_SRC = '../../js/logistica/logistica-dark-conversation-slide-reference.js';
  ...
  function ensureConversationSlideModule() {
    ensureScript(CONVERSATION_SLIDE_SCRIPT_ID, CONVERSATION_SLIDE_SCRIPT_SRC);
  }
  ...
  function scheduleDarkModules() {
    ...
    window.setTimeout(ensureConversationSlideModule, 0);
    window.setTimeout(ensureConversationSlideModule, 180);
    window.setTimeout(ensureConversationSlideModule, 520);
  }
