...
(function () {
  ...
  function loadProductosComestibles_() {
    ...
    ensureScript_('../js/productos-comestibles-optionals-storage-sync.js', 'productos-comestibles-optionals-storage-sync-js');
    ensureScript_('../js/productos-comestibles-optionals-durable-bridge.js', 'productos-comestibles-optionals-durable-bridge-js');
    ...
    ensureCss_('../css/productos-comestibles-extras-hard-fix.css', 'productos-comestibles-extras-hard-fix-css');
    ensureScript_('../js/productos-comestibles-phantom-delete-purge.js', 'productos-comestibles-phantom-delete-purge-js');
